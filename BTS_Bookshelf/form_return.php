...
<ul class="form">
  ...
  <li><label for"title">Book:</label>
   ...
   <input type="text" name="borrower" value="<?php echo $borrower; ?>" readonly/></li>

  <li><label for"description">Verified by:</label>
   <input type="text" name="verifier_in"/></li>

   <input type="hidden" name="verifier" value="<?php echo $verifier; ?>" readonly/>
  ...
  <input type="date" name="date_return"/>
    ...
    <li><button class="submit" type="submit" name="available" value="yes">Submit</button></li>
</ul>
</form>
